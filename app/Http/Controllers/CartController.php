...
class CartController extends Controller
{
    ...
    public function saveBenefits(){
        ...
        foreach($cart as $benefit){
            $employee_benefits = new EmployeeAvailedBenefits();
            $employee_benefits->employee_id = $benefit->employee_id;
            $employee_benefits->date_availed = Carbon::now();
            $employee_benefits->benefit_id = $benefit->benefit_id;
            $employee_benefits->category_id = $benefit->category_id;
            $employee_benefits->price = $benefit->price;
            $employee_benefits->quantity = $benefit->quantity;
            $employee_benefits->description = $benefit->description;
